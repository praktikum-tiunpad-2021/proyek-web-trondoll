        ...
        <div class="container-mui nav-container">
            <div class="nav-kiri">
                ...
                <div class="main-nav">
                    ...
                    <div style="display: inline-block; padding: 25px 40px 19px;"><a style="display: inline-block; font-size: 15px; letter-spacing: 0.14px; width: auto; text-decoration: none; color: #fff;">Konsultasi</a></div>
                ...
                <div class="main-nav-second">
                    <div style="display: inline-block; padding: 60px 40px 10px;"><a href="login.html" value="Masuk" style="display: inline-block; font-size: 15px; letter-spacing: 0.14px; width: auto; text-decoration: none; color: #fff;">Masuk</a></div>
                    <div style="display: inline-block; padding: 25px 40px 10px;"><a href="" style="display: inline-block; font-size: 15px; letter-spacing: 0.14px; width: auto; text-decoration: none; color: #fff;">Beranda</a></div>
                    ...
                    <div style="display: inline-block; padding: 25px 40px 10px;"><a href="" style="display: inline-block; font-size: 15px; letter-spacing: 0.14px; width: auto; text-decoration: none; color: #fff;">Kelas</a></div>
            ...
            <div class="nav-kanan">
                <div class="nav-masuk">
                    <a <?= $isActivePage('/'); ?> href="/login" value="Masuk">
                        <p style="text-align: center; justify-content: center; text-decoration: none;">Masuk</p>
                    </a>
                </div>
            </div>
