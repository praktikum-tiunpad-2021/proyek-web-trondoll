        ...
        <div class="container-mui nav-container">
            <div class="nav-kiri">
                ...
                <div class="main-nav">
                    ...
                    <div style="display: inline-block; padding: 25px 40px 19px;"><a href="/aboutus2" style="display: inline-block; font-size: 15px; letter-spacing: 0.14px; width: auto; text-decoration: none; color: #fff;">Tentang Kami</a></div>
                </div>
                ...
                <div class="main-nav-second">
                    ...
                    <div style="display: inline-block; padding: 25px 40px 10px;"><a <?= $isActivePage('/'); ?> href="/login" style="display: inline-block; font-size: 15px; letter-spacing: 0.14px; width: auto; text-decoration: none; color: #fff;">Konsultasi</a></div>
                    ...
                    <div style="display: inline-block; padding: 25px 40px 10px;"><a <?= $isActivePage('/'); ?> href="/login" style="display: inline-block; font-size: 15px; letter-spacing: 0.14px; width: auto; text-decoration: none; color: #fff;">Kelas</a></div>
                    <div style="display: inline-block; padding: 25px 40px 10px;"><a href="/aboutus2" style="display: inline-block; font-size: 15px; letter-spacing: 0.14px; width: auto; text-decoration: none; color: #fff;">Tentang Kami</a></div>
